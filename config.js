 ...
 *              - 1-Click Hall Rental Agreement & Google/Apple Calendar Sync
 * 
...
const FRATERNAL_CONFIG = {
  ...
  payments: {
    ...
    stripeSecretKey: "",
    cashAppHandle: "$Lodge100Community",
    venmoHandle: "@Lodge100-Charity",
    chimeSign: "$Lodge100Anytown",
    zelleRecipient: "treasurer@communitylodge100.org",
  ...
  // Bidirectional Live Feed Bridge & Calendar Sync
  feedBridge: {
  ...
  // Database Backend Connector (MySQL with automatic SQLite Fallback)
  database: {
    type: "mysql_or_sqlite",
    sqliteFile: "vefa.sqlite",
    apiBaseUrl: "api/"
  }
};
