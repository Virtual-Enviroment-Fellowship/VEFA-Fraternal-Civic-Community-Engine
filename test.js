...
// TEST 11: Hostinger Deployment & Platform Guides
console.log("\nTest Suite 11: Hostinger Deployment & Platform Guides");
assert(fs.existsSync(path.join(__dirname, 'PLATFORM_HOSTING_GUIDE.md')), 'PLATFORM_HOSTING_GUIDE.md exists');
assert(fs.existsSync(path.join(__dirname, 'HOSTINGER_DEPLOYMENT_GUIDE.md')), 'HOSTINGER_DEPLOYMENT_GUIDE.md exists');
assert(fs.existsSync(path.join(__dirname, 'vefa-deployer.php')), 'vefa-deployer.php exists');
const deployerContent = fs.readFileSync(path.join(__dirname, 'vefa-deployer.php'), 'utf8');
assert(deployerContent.includes('pdo_mysql'), 'vefa-deployer.php tests for pdo_mysql extension');
